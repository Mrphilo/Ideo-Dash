...
class Statistique
{
     ...
     * @var int
     *
     * @ORM\Column(name="total_users", type="integer" , nullable=true)
     */
    private $totalUsers;
     ...
     * @var int
     *
     * @ORM\Column(name="course_enrollments", type="integer" , nullable=true)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="course_enrollments_not_started", type="integer", nullable=true)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="course_enrollments_in_progress", type="integer", nullable=true)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="course_enrollments_completed", type="integer", nullable=true)
     */
     ...
     * @var int
     *
     * @ORM\Column(name="course_enrollments_expired", type="integer", nullable=true)
     */
