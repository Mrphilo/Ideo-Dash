...
use Ideo\DashBundle\Entity\Contrat;
...
class ContratController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $contrats = $em->getRepository('IdeoDashBundle:Contrat')->findAll();

        return $this->render('IdeoDashBundle:contrat:index.html.twig', array(
            'contrats' => $contrats,
        ));
    }
    ...
    {
        $contrat = new Contrat();
        $form = $this->createForm('Ideo\DashBundle\Form\ContratType', $contrat);
        ...
        return $this->render('IdeoDashBundle:contrat:new.html.twig', array(
            'contrat' => $contrat,
    ...
    public function showAction(Contrat $contrat)
    {
        ...
        return $this->render('IdeoDashBundle:contrat:show.html.twig', array(
            'contrat' => $contrat,
    ...
    {
        $deleteForm = $this->createDeleteForm($contrat);
        $editForm = $this->createForm('Ideo\DashBundle\Form\ContratType', $contrat);
        ...
        return $this->render('IdeoDashBundle:contrat:edit.html.twig', array(
            'contrat' => $contrat,
