...
use Ideo\DashBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    {
        $em = $this->getDoctrine()->getManager();
        $info_client_and_stats = $em->getRepository('IdeoDashBundle:Client')->findClientInfoAndStatsById($client->getId());
        ...
        {
            $service = $em->getRepository('IdeoDashBundle:Service')->findServiceById($client->getIdService());
            $contrat = $em->getRepository('IdeoDashBundle:Contrat')->findContratById($client->getIdContrat());
    ...
    public function editAction(Request $request, Client $client)
    {
        ...
        $editForm = $this->createForm('ClientType', $client);
